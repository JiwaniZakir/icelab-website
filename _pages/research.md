...
{% include figure.liquid loading="lazy" path="assets/img/research/analog.png" title="Analog IC" class="img-fluid rounded z-depth-1" %}
</div>
</div>

---

## Digital VLSI & Hardware Accelerators

<div class="row">
<div class="col-sm-4 mt-3 mt-md-0">
{% include figure.liquid loading="lazy" path="assets/img/research/digital.png" title="Digital VLSI" class="img-fluid rounded z-depth-1" %}
</div>
<div class="col-sm-8 mt-3 mt-md-0">
...
<div class="col-sm-4 mt-3 mt-md-0">
{% include figure.liquid loading="lazy" path="assets/img/research/rf.png" title="RF Circuits" class="img-fluid rounded z-depth-1" %}
</div>
</div>
...
<div class="row">
<div class="col-sm-4 mt-3 mt-md-0">
{% include figure.liquid loading="lazy" path="assets/img/research/emerging.png" title="Emerging Tech" class="img-fluid rounded z-depth-1" %}
</div>
<div class="col-sm-8 mt-3 mt-md-0">
...
Our lab is equipped with industry-standard EDA tools and measurement equipment:

- **EDA:** Cadence Virtuoso, Synopsys Design Compiler, Mentor Calibre, Xilinx Vivado
- **Measurement:** High-speed oscilloscopes, spectrum analyzers, network analyzers, probe stations
- **Fabrication access:** TSMC, GlobalFoundries, and SkyWater PDKs via university shuttle programs
